<?php
/****************************************************************
File Name       : tracuulayout.blade.php
...
<div id="main">
    ...
    <div class="container warper">
        ...
        <div class="container-fluid row main-content" style="font-size: 12px;">
            ...
            <div class="col-xs-4 panel-group">
                ...
                <div class="panel panel-default panel-home">
                    ...
                    <div class="list-group">
                        <a class="list-group-item" href="{{url('/ketquaxulydonthukhieunaitocao')}}">Xử lý đơn khiếu nại, kiến nghị, phản ánh, tố cáo</a>
                        <a class="list-group-item" href="{{url('/tracuu')}}">Quyết định giải quyết KNTC</a>
                    </div>
                </div>
                ...
                <div class="panel panel-default panel-home">
                    ...
                    <div class="list-group">
                        <a class="list-group-item" href="{{url('/ketquatiepdan')}}">Kết quả tiếp dân</a>
                        <a class="list-group-item" href="{{url('/lichtiepcongdan')}}">Lịch tiếp dân</a>
                    </div>
                </div>
