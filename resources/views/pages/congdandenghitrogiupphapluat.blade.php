...
@section('content')
    ...
    <div class="panel panel-default panel-home">
        <div class="panel-heading">
            ...
            Công dân đề nghị trợ giúp pháp luật
        </div>
        <form role="form" method="post" action="submittrogiupphapluat">
            <div id="trogiupphapluat" class="form-horizontal">
                @if (session('submittrogiupphapluat_result'))
                    <div style="margin-top: 10px; margin-left: 40%">
                        <label class="text-success"><span class='glyphicon glyphicon-ok'></span> Cảm ơn bạn đã trợ giúp !!! </label>
                    </div>
                @endif
