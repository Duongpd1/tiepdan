...
@section('content')
    ...
    <div class="col-background">
        <div class="panel panel-default panel-min-height">
            <div class="panel-heading text-center">THÊM THÔNG TIN TIẾP DÂN</div>
            <form role="form" id="themthongtintiepdan" method="post" action="submitthemthongtintiepdan" enctype="multipart/form-data">
                {{csrf_field() }}
                ...
                <div class="panel-body form-horizontal">
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-xs-10">
                            <input name="sohieu" type="text" maxlength="50" id="sohieu" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-xs-10">
                            <input name="coquanbanhanh" type="text" maxlength="160" id="coquanbanhanh" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-xs-2">
                            <div class="input-group date">
                                <input name="ngaybanhanh" type="text" value="{{date('Y-m-d')}}" id="ngaybanhanh" class="form-control" placeholder="dd-mm-yyyy" data-provide="datepicker" required>
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-xs-10">
                            <input name="trichdan" type="text" maxlength="250" id="trichdan" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group form-group-sm">
